...
# Set up GPIO pin factory for controlling hardware
...
SERVOOFFSET = -40     # Offset for the servo angle to adjust its position
...
# Set initial servo angle with offset applied
servo.angle = 2 + SERVOOFFSET
